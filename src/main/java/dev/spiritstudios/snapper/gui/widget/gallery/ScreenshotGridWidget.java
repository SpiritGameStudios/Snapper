        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean isHovering, float a) {
            ...
            if (this.texture.isLoaded()) {
                ...
                if ((isHovering && mouseX < getX() + getWidth()) || safeIsSelected(this)) {
                    ...
                    graphics.text(
                            minecraft.font,
                            SnapperComponents.clipTextIfNeeded(fileName, minecraft.font, getContentWidth() - 5),
                            getContentX() + 5,
                            getContentY() + 6,
                            CommonColors.WHITE,
                            true
                    ...
                    graphics.text(
                            minecraft.font,
                            SnapperComponents.clipTextIfNeeded(creation, minecraft.font, getContentWidth() - 5),
                            getContentX() + 5,
