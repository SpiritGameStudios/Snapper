...
public abstract class KeyboardMixin {
     ...
     * @reason Change message logic to show a push instead of chat message
     */
    @Overwrite
    private void method_1464(Text text) {
        // Lovely tree of decisions to decide what instructions make sense. <3 Lynn
        String inGameDeterminedDescription = client.currentScreen == null ? "push.snapper.screenshot.created.description"
                : "push.snapper.screenshot.created.description_in_menu";
        String copyDeterminedDescription = SnapperConfig.INSTANCE.copyTakenScreenshot.get() ?
                "push.snapper.screenshot.created.description_copy" : inGameDeterminedDescription;
